...
import ma.emsi.digital_banking_backend.mappers.CustomerMapperImpl;
...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public CurrentBankAccountDTO saveCurrentBankAccount(double initialBalance, double overDraft, Long customerId) throws CustomerNotFoundException {
        ...
        return customerMapper.fromCurrentBankAccount(savedBankAccount);
    }
    ...
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interestRate, Long customerId) throws CustomerNotFoundException {
        ...
        return customerMapper.fromSavingBankAccount(savedBankAccount);
    }
    ...
    public BankAccountDTO getBankAccount(String accountId) throws BankAccountNotFoundException {
        ...
        if(bankAccount instanceof SavingAccount){
            ...
            return customerMapper.fromSavingBankAccount(savingAccount);
        } else {
            CurrentAccount currentAccount= (CurrentAccount) bankAccount;
            return customerMapper.fromCurrentBankAccount(currentAccount);
        }
    }
